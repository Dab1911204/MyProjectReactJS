                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td>Giảm giá</td>
                                <td>
                                    <input type="number" name="discountPercentage" onChange={handleChange} value={data.discountPercentage} />
                                </td>
                            </tr>
                            <tr>
                                <td>Số lượng còn lại</td>
                                <td>
                                    <input type="number" name="stock" onChange={handleChange} value={data.stock} />
                                </td>
                            </tr>
                            <tr>
                                <td>Đường dẫn ảnh</td>
